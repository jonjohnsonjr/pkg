...
import (
	...
	istiov1alpha1 "github.com/knative/pkg/apis/istio/v1alpha1"
	...
	v1alpha1 "github.com/knative/pkg/client/listers/istio/v1alpha1"
...
func (f *policyInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&istiov1alpha1.Policy{}, f.defaultInformer)
}
